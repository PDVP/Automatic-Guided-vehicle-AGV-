...
int PULSE_LENGTH=1540; //set the pulse length in microseconds (The PPM signal pulse width must range from 600us to 2.4ms. The motor speed will be zero at PPM pulse width of 1.51ms)
...
ISR(TIMER1_COMPA_vect){  //leave this alone
 ...
 long Encoder_check =33300;//1,33,600
 if( tick >= Encoder_check){
   PULSE_LENGTH = 1510 ;
   delay(10000);
   tick=0;
   PULSE_LENGTH = 1540 ;
